...
};return d;}());a.Formatter=c;});define("lib/ss/preview/templates",["require","exports"],function(b,a){a.diceTagTemplateHTML=null;a.defaultTemplate=null;
a.defaultSeparator=null;a.diary=null;a.diaryCharCountsHTML=null;a.message=null;a.partyBBS=null;a.serif=null;});define("lib/preview/config",["require","exports"],function(b,a){a.neverUpdateHTMLIfHidden=true;
...
a.Preview=d;var e;(function(f){f.imgBaseURL=null;f.showsCharCountsOnDiary=true;f.randomizesDiceTagResult=false;})(e=a.SSPreview||(a.SSPreview={}));});define("lib/ss/preview/model_formatter",["require","exports","lib/util/string/format","lib/util/string/replaceLoop","lib/util/html/escape","lib/util/html/tag","lib/ss/expr/parser","lib/ss/preview/config"],function(b,d,g,h,j,i,f,a){var e=(function(){function k(){}k.removeIndents=function(l){return l.replace(/^[\t ]+/gm,"");
};k.removeLineBreaks=function(l){return l.replace(/\r\n|\r|\n/g,"");};k.Normalize=function(l){var n={};for(var o in l){var m=l[o];if(typeof m==="string"){n[o]=this.removeLineBreaks(this.removeIndents(m));
}}return n;};return k;}());var c=(function(){function k(l){this.reReplace_EscapedDecoTag=new RegExp(j.escape("<(F[1-7]|B|I|S)>([\\s\\S]*?)</\\1>"),"g");
this.reReplace_EscapedDiceTag=new RegExp(j.escape("<D>"),"g");this.Profile=l.profile;this.StringModeAsDefault=l.stringModeAsDefault||false;this.AllowsOrTag=l.allowsOrTag||false;
this.setIcon0AsDefaultWithNameTags=l.setIcon0AsDefaultWithNameTags||false;this.Template=l.template||a.Templates.defaultTemplate||k._DEFAULT_TEMPLATE;var m=a.Templates.defaultSeparator||k._DETAULT_SEPARATORS;
if(l.separators){this.Separators={and:(l.separators.and===void 0||l.separators.and===null)?m.and:l.separators.and,or:(l.separators.or===void 0||l.separators.or===null)?m.or:l.separators.or};
}else{this.Separators=m;}if(l.htmlEmptyOrBlock===void 0||l.htmlEmptyOrBlock===null){this.htmlEmptyOrBlock=k._DEFAULT_TEMPLATE.Body_WhenOrIsEmpty;}else{this.htmlEmptyOrBlock=l.htmlEmptyOrBlock;
}}Object.defineProperty(k.prototype,"Profile",{get:function(){return this.profile;},set:function(l){this.profile=l;},enumerable:true,configurable:true});
Object.defineProperty(k.prototype,"Template",{get:function(){return this.template;},set:function(l){this.template=e.Normalize(l);},enumerable:true,configurable:true});
Object.defineProperty(k.prototype,"Separators",{get:function(){return this.separators;},set:function(l){this.separators=e.Normalize(l);},enumerable:true,configurable:true});
Object.defineProperty(k.prototype,"StringModeAsDefault",{get:function(){return this.stringModeAsDefault;},set:function(l){this.stringModeAsDefault=l;},enumerable:true,configurable:true});
Object.defineProperty(k.prototype,"AllowsOrTag",{get:function(){return this.allowsOrTag;},set:function(l){this.allowsOrTag=l;},enumerable:true,configurable:true});
Object.defineProperty(k.prototype,"HTMLEmptyOrBlock",{get:function(){return this.htmlEmptyOrBlock;},set:function(l){this.htmlEmptyOrBlock=l;},enumerable:true,configurable:true});
k.prototype.Exec=function(m){var l=j.escape(m);l=h(l,this.reReplace_EscapedDecoTag,"<span class='$1'>$2</span>");l=this.Format(l);l=l.replace(this.reReplace_EscapedDiceTag,function(n){return k.GenerateDiceTag(a.SSPreview.randomizesDiceTagResult);
});l=i.lineBreaksToBR(l);l=j.unescape(l,"<BR>","g");return l;};k.prototype.Format=function(l){if(this.allowsOrTag){return this.FormatOrs(f.Parser.ParseOr(l));
}else{return this.FormatAnds(f.Parser.ParseAnd(l));}};k.prototype.FormatOrs=function(q){var l=[];for(var o=0,n=q.length;o<n;o++){var m=q[o];var p=m.length===1&&([m[0].source.separator,m[0].source.text].join("")==="");
if(p&&this.htmlEmptyOrBlock!==null){l.push(this.htmlEmptyOrBlock);}else{l.push(this.FormatAnds(q[o]));}}return l.join(this.separators.or);};k.prototype.FormatAnds=function(v){var l=[];
var x=k.DefaultIconURL();for(var u=0,r=v.length;u<r;u++){var p=v[u];var o=void 0;if(p.attr.stringMode===void 0){o=this.stringModeAsDefault;}else{if(this.stringModeAsDefault&&p.attr.changedName===void 0){o=true;
}else{o=p.attr.stringMode;}}var s=void 0;if(p.attr.changedName===void 0){s=this.profile.nickname;}else{s=p.attr.changedName;}var n=void 0;if(p.attr.iconNumber===void 0){n=-1;
}else{n=parseInt(p.attr.iconNumber);}var q=void 0;if(n===-1){if(this.setIcon0AsDefaultWithNameTags||!p.source.separator){q=this.profile.iconURLArray[0];
}}else{q=this.profile.iconURLArray[n];}if(!q){q=x;}var m=void 0;var z=void 0;if(o){m=p.source.text;z="";}else{var y=k.takeLineBreaksFromEnd(p.source.text);
m=y.text;z=y.breaks||"";}var w=void 0;if(o){if(n===-1){w=this.template.Body_StringMode;}else{w=this.template.Body_StringModeAndIcon;}}else{w=this.template.Body_WordsMode;
}l.push(g(w,{iconURL:q,name:s,nameColor:this.profile.nameColor,bodyHTML:m,endBreaks:z}));}return l.join(this.separators.and);};k.DefaultIconURL=function(){return((a.SSPreview.imgBaseURL||k._DEFAULT_IMG_BASE_URL)+"default.jpg");
};k.GenerateDiceTag=function(l){if(l===void 0){l=false;}var m=1;if(l){m=Math.floor(Math.random()*6)+1;}return g(a.Templates.diceTagTemplateHTML||k._DEFAULT_DICE_TEMPLATE,{imgDir:a.SSPreview.imgBaseURL||k._DEFAULT_IMG_BASE_URL,resultNum:m});
};k.takeLineBreaksFromEnd=function(o){var l=/\n+$/.exec(o);if(!l){return{text:o};}var n=l[0];var p=o.slice(0,-(n.length));return{text:p,breaks:n};};k._DEFAULT_TEMPLATE={Body_WordsMode:'<table class="WordsTable" CELLSPACING=0 CELLPADDING=0><tr><td class="Icon" rowspan="2"><IMG border = 0 alt=Icon align=left src="{iconURL}" width=60 height=60></td><td class="Name"><font color="{nameColor}" class="B">{name}</font></td></tr><tr><td class="Words">\u300C{bodyHTML}\u300D{endBreaks}</td></tr></table>',Body_StringModeAndIcon:'<table class="WordsTable" CELLSPACING=0 CELLPADDING=0><tr><td class="Icon"><IMG border = 0 alt=Icon align=left src="{iconURL}" width=60 height=60></td><td class="String">{bodyHTML}</td></tr></table>',Body_StringMode:'<table class="WordsTable" CELLSPACING=0 CELLPADDING=0><tr><td class="Icon"/><td class="String">{bodyHTML}</td></tr></table>',Body_WhenOrIsEmpty:'<table class="WordsTable" CELLSPACING=0 CELLPADDING=0><tr><td class="Icon"/><td class="String"><span class=\'I\'>(\u8868\u793A\u306A\u3057)</span></td></tr></table>'};
k._DEFAULT_DICE_TEMPLATE='<img alt="dice" src="{imgDir}d{resultNum}.png" border="0" height="20" width="20">';k._DEFAULT_IMG_BASE_URL="http://www.sssloxia.jp/p/";
k._DETAULT_SEPARATORS={and:"",or:"<div class='separator_or'/>"};return k;}());d.SSFormatter=c;});define("lib/interface/disposable",["require","exports"],function(b,a){});
